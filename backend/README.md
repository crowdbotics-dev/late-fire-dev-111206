...
## Project Structure
    ...
    ├── late_fire_dev_111206  # Django project configurations
...
1. Clone this repo and `cd late_fire_dev_111206`
...
2. Clone this repo and `cd late_fire_dev_111206`
