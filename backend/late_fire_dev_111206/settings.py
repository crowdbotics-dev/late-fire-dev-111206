"""
Django settings for late_fire_dev_111206 project.
...
ROOT_URLCONF = 'late_fire_dev_111206.urls'
...
WSGI_APPLICATION = 'late_fire_dev_111206.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_fire_dev_111206 API",
    "DESCRIPTION": "API documentation for late_fire_dev_111206 App",
    "VERSION": "v1",
}
